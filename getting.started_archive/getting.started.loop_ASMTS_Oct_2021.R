...
#NOTE: When using in a loop this currently re-appends headers for each loop. Easy enough to clean up in excel and don't use this often, but could use a code update to fix.
