...
component<-c('NITROGEN, NITRATE (AS N)','NITROGEN, NITRITE','Nitrogen, ammonia (As N)','Orthophosphate as Phosphorus, Dissolved')
of<-c('Nitrate+Nitrite as Nitrogen','Nitrate+Nitrite as Nitrogen','Nitrogen','PHOSPHORUS, TOTAL (AS P)')
