...
data$EBpass<-ifelse(is.na(data$blank),"A",ifelse(data$result_value<=3*(data$blank),"R",ifelse(data$result_value<=5*(data$blank),"trend",ifelse(data$result_value<=10*(data$blank),"J","A"))))
```
