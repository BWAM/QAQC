...
1. Select a reporting limit informed by plotting the blank readings  
2. Using this reporting limit, identify the EB failures
3. Examine the failures to see if there are any field or lab errors that could explain them (with RoseAnn's assistance)  
4. Flag the data to communicate its best use (regulatory, trend analysis...etc)    

### Info from EDD reports
Conclusions drawn from reading lab reports  
I have to read these when I get back

###plots    
I only plotted parameters with EB failures.  
The purpose of these plots is to see how whether the failures were outliers or were part of an underlying noise. If the latter, then we should consider raising the reporting limit.  
