...
<!-- NOTE: Results are sometimes flagged '*' because of a holding time violation which we actually feel is an okay exceedence of HT.   -->

In order to review the narrative reports, you will need the following list of lab_sdg's associated with these data:  
```{r message=FALSE, warning=FALSE, results='asis'}
qualifiers<-unique(data[c('lab_sdg')])
...
data$labpass <- ifelse(data$labpass == "" | is.na(data$labpass),
                       "A",
                       data$labpass)
```
