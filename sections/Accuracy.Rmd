...
for(i in 1:nparams){
  ...
  for(j in 1:nsites){
    ...
    #Somewhere in this code block, add code to print out (into new field) which QC sample was used to determine flag?
    #Would need to do for all child Rmd's
