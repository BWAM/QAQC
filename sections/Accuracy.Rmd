...
* Accuracy
    ...
    + designated 'spike' samples are spiked with a known concentration. The difference between the concentration before and after should be the spiked amount +/- the accuracy criteria established by the standard methods manual and listed in tables 3 and 4.  
